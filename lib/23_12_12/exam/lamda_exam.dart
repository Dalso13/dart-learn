...
main() {
  ...
  tra.forEach((e) => print(e.trader.name));
  print("------------");
  ...
  // 4. 모든 거래자의 이름을 알파벳순으로 정렬하여 나열하시오
    // sorted 사용 x
  final names = transactions.map((e) => e.trader.name).toList(); // 중복 제거시 toSet()
  names.sort();
  names.forEach(print);
  print("------------");
  // 5. 밀라노에 거래자가 있는가?
  ...
  transactions.where((e) => e.trader.city == "Cambridge").forEach((e) => print(e.value));
  print("------------");
